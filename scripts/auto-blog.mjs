#!/usr/bin/env node
/**
 * auto-blog.mjs — generates a new blog post every 2 weeks from rotating templates.
 * Runs on a GitHub Actions cron (see .github/workflows/marketing.yml).
 * No secrets needed — content is templated, bilingual, and SEO-friendly.
...
const TEMPLATES = [
  {
    slug: 'daily-habits-of-top-performers',
    titleEn: 'The Daily Habits of Top Performers',
    titleAr: 'عادات النخبة اليومية',
  ...
  {
    slug: 'negotiation-mistakes-that-cost-you',
    titleEn: 'Negotiation Mistakes That Quietly Cost You',
    titleAr: 'أخطاء التفاوض التي تكلّفك بصمت',
  ...
  },
  {
    ...
    titleEn: 'How to Learn Anything Faster',
    titleAr: 'كيف تتعلّم أي شيء أسرع',
